...
<%@page import="controller.ProfesseurController"%>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="http://localhost:8080/CrudProfessors_Specialite/specialites.jsp">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="id" value="<%= (professeur == null) ? "search" : professeur.getId() %>" />
                <div class="row">
                <div class="row col-md-4 py-2">
                    <label>Date Embauche Min</label>
                    <input id="dateInput" class="form-control" type="date" name="dateEmbaucheMin" value="<%= (professeur == null) ? "" : professeur.getDateEmbauche()%>" />
                </div>
                <div class="row col-md-4 py-2">
                    <label>Date Embauche Max</label>
                    <input id="dateInput" class="form-control" type="date" name="dateEmbaucheMax" value="<%= (professeur == null) ? "" : professeur.getDateEmbauche()%>" />
                </div>
                <div class="row col-md-4 py-2">
                    <label>Specialite</label>
                    <select id="specInput" class="form-control" name="specialite">
                        <%
                    ...
                    <button class="col-md-8 mx-auto btn btn-outline-danger btn-block" type="submit">Search</button>
                    <script>
                      function myFunction() {
