...
public final class specialites_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("              </li>\n");
      out.write("              <li class=\"nav-item\">\n");
      out.write("                <a class=\"nav-link\" href=\"http://localhost:8080/CrudProfessors_Specialite/graph.jsp\">\n");
      out.write("                  <span data-feather=\"bar-chart-2\"></span>\n");
      out.write("                  Analytics\n");
      out.write("                </a>\n");
      out.write("              </li>\n");
      out.write("              <li class=\"nav-item\">\n");
      out.write("                <a class=\"nav-link\" href=\"http://localhost:8080/CrudProfessors_Specialite/specialites.jsp\">\n");
      out.write("                  <span data-feather=\"users\"></span>\n");
      out.write("                  Customers\n");
      out.write("                </a>\n");
      out.write("              </li>\n");
      ...
      out.print( (professeur == null) ? "search" : professeur.getId() );
      out.write("\" />\n");
      out.write("                <div class=\"row\">\n");
      out.write("                <div class=\"row col-md-4 py-2\">\n");
      out.write("                    <label>Date Embauche Min</label>\n");
      out.write("                    <input id=\"dateInput\" class=\"form-control\" type=\"date\" name=\"dateEmbaucheMin\" value=\"");
      out.print( (professeur == null) ? "" : professeur.getDateEmbauche());
      out.write("\" />\n");
      out.write("                </div>\n");
      out.write("                <div class=\"row col-md-4 py-2\">\n");
      out.write("                    <label>Date Embauche Max</label>\n");
      out.write("                    <input id=\"dateInput\" class=\"form-control\" type=\"date\" name=\"dateEmbaucheMax\" value=\"");
      out.print( (professeur == null) ? "" : professeur.getDateEmbauche());
      out.write("\" />\n");
      out.write("                </div>\n");
      out.write("                <div class=\"row col-md-4 py-2\">\n");
      out.write("                    <label>Specialite</label>\n");
      out.write("                    <select id=\"specInput\" class=\"form-control\" name=\"specialite\">\n");
      out.write("                        ");

                            List<Specialite> specs = new ArrayList<Specialite>();
                            specs.add(new Specialite("", ""));
                            specs.addAll(specialiteService.findAll());
 ...
 if (professeur != null && specialiteService.findById(professeur.getSpecialite()).getLibelle().equals(s.getLibelle())) { 
      ...
      out.write("                </div>\n");
      out.write("                </div>\n");
      out.write("                    <button class=\"col-md-8 mx-auto btn btn-outline-danger btn-block\" type=\"submit\">Search</button>\n");
      out.write("                    <script>\n");
      out.write("                      function myFunction() {\n");
      out.write("                      document.getElementById(\"dateInput\").value = \"\";\n");
      out.write("                      document.getElementById(\"specInput\").value = \"\";\n");
      out.write("                        }\n");
      out.write("                      </script>\n");
      out.write("                </form>\n");
      out.write("            </div>\n");
      ...
      out.write("               ");
                        ...
                        for (Professeur p : ProfesseurController.searchedProfesseurs) {
